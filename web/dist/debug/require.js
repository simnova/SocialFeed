...
this['JST']['app/templates/socialFeed.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push(''); _.each(collection,function(collectionItem){   ;__p.push('\r\n<div class="socialFeedItem clearfix" style="background-size: 220px; background:url(', collectionItem.image ,'); background-repeat:no-repeat; min-height:220px;">\r\n  <div style="margin-top:150px;overflow:hidden;max-height:70px;background-color:rgba(0, 0, 0, 0.52)">\r\n    <span style="background-color:yellow">', collectionItem.source ,'</span>\r\n    <span style="background-color:green;color:white">', collectionItem.username ,'</span>\r\n    <span style="background-color:blue;color:white">', collectionItem.description ,'</span>\r\n  </div>\r\n</div>\r\n\r\n'); }); ;__p.push('\r\n');}return __p.join('');
}(data, _)};

this['JST']['app/templates/wordGenerator.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\r\n<select id="first">\r\n'); _.each(collection.models,function(collectionItem){   ;__p.push('\r\n <option value="', collectionItem.get("id") ,'">', collectionItem.get("root") ,'</option>\r\n'); }); ;__p.push('\r\n</select>\r\n\r\n<select id="middle">\r\n'); _.each(collection.models,function(collectionItem){   ;__p.push('\r\n <option value="', collectionItem.get("id") ,'">', collectionItem.get("root") ,'</option>\r\n'); }); ;__p.push('\r\n</select>\r\n\r\n<select id="last">\r\n'); _.each(collection.models,function(collectionItem){   ;__p.push('\r\n <option value="', collectionItem.get("id") ,'">', collectionItem.get("root") ,'</option>\r\n'); }); ;__p.push('\r\n</select>\r\n\r\n<div id="results"></div>');}return __p.join('');
}(data, _)};
...
define("jqueryMasonry", function(){});

define('use!jqueryMasonry', ['jquery'],function() {return window['undefined'];});
...
define('instagramFeed',['jquery','use!underscore'], function ($,_) {
...
define('twitterFeed',['jquery','use!underscore'], function ($,_) {
...
define('facebookFeed',['jquery','use!underscore'], function ($,_) {
...
require.config({
  ...
  paths: {
    ...
    jqueryMasonry: "../assets/js/libs/jquery.masonry.min",
    underscore: "../assets/js/libs/underscore",
    backbone: "../assets/js/libs/backbone",

    instagramFeed: "../assets/js/libs/instagramFeed",
    twitterFeed: "../assets/js/libs/twitterFeed",
    facebookFeed: "../assets/js/libs/facebookFeed",
    // Shim Plugin
